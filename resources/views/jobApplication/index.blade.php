                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{Form::date('start_date',$filter['start_date'],array('class'=>'month-btn form-control ','required'=>'required'))}}
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{Form::date('end_date',$filter['end_date'],array('class'=>'month-btn form-control ','required'=>'required'))}}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    {{ Form::label('job', __('Job'),['class'=>'form-label']) }}
                                    {{ Form::select('job', $jobs,$filter['job'], array('class' => 'form-control select','required'=>'required')) }}
                                </div>
                            </div>
