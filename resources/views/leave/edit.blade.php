    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{Form::select('leave_type_id',$leavetypes,null,array('class'=>'form-control select','required'=>'required','placeholder'=>__('Select Leave Type')))}}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{Form::textarea('remark',null,array('class'=>'form-control','placeholder'=>__('Leave Remark'),'required'=>'required'))}}
            </div>
        </div>
    </div>
    @role('Company')
