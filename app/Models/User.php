...
class User extends Authenticatable
{
    ...
    public function getProfileAttribute()
    {
        ...
        {
            return $this->attributes['avatar'] = asset(\Storage::url('uloads/avatar'.'/'.$this->avatar));
        }
        else
        {
    ...
    public function priceFormat($price)
    {
        ...
        $decimal_number = Utility::getValByName('decimal_number') ? Utility::getValByName('decimal_number') : 2;
