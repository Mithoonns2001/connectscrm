        ...
        <div class="container">
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead lh-180"><i class="fas fa-map-marker-alt"></i><?php echo e($job->position); ?> <?php echo e(__('Position')); ?></p>
                    <p class="lead lh-180"><i class="ti ti-map-pin"></i> <?php echo e(!empty($job->branches)?$job->branches->name:''); ?> </p>
                ...
                <div class="col-lg-10">
                    <div class="card shadow">
                        <div class="card-body px-lg-5 py-lg-5">
                            <h4 class=""><?php echo e(__('Requirements')); ?></h4>
                    ...
                    <div class="card shadow">
                        <div class="card-body px-lg-5 py-lg-5">
                            <h4 class=""><?php echo e(__('Description')); ?></h4>
...
<?php /**PATH /home/u448490903/domains/srmconnects.com/public_html/connectscrm/resources/views/job/requirement.blade.php ENDPATH**/ ?>