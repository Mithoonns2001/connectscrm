        ...
        <table class="add-border invoice-summary" style="margin-top: 30px;">
            ...
            <?php if(isset($invoice->itemData) && count($invoice->itemData) > 0): ?>
                ...
                <tr>
                    ...
                    <td><?php echo e(Utility::priceFormat($settings,$item->price * $item->quantity -  $item->discount )); ?></td>
...
<?php /**PATH /home/u448490903/domains/srmconnects.com/public_html/connectscrm/resources/views/invoice/templates/template1.blade.php ENDPATH**/ ?>